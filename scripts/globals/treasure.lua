...
function chestLoot(zone,npc)
    ...
    local gems =
    {
        ...
        15, {0.080,5271,5278,5294,5299,5334,5353},
        28, {0.071,0x316,0x31F,0x32F,0x314,0x31C},
        45, {0.008,0x32B,0x316,0x328,0x314,0x31F,0x32F},
        132,{0.090,0x32B,0x316,0x31C,0x31E,0x328,0x32F},
        ...
        215,{0.204,0x31E,0x316,0x328,0x314,0x32F,0x31C},
        216,{0.162,0x32B,0x316,0x328,0x31C,0x31F,0x314,0x32F,0x31E},
        217,{0.230,0x32E,0x320,0x329,0x31B,0x327,0x326},
        218,{0.107,0x32B,0x316,0x328,0x31C,0x31F,0x314,0x32F,0x31E},
        253,{0.161,0x32E,0x320,0x329,0x31B,0x31C,0x31F,0x326},
        254,{0.161,0x32E,0x320,0x329,0x31B,0x31C,0x31F,0x326}
    };
    local items =
    {
        9,  {},
